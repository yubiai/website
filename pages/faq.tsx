          ...
          >
            ...
            >
              <Heading>
                <Text
                  fontSize={"42px"}
                  color="white">{t("What is Yubiai?")}</Text>
              </Heading>
              ...
              <Heading mt="0.25em">
                <Text fontSize={"42px"} color="white">{t("How do I use Yubiai?")}</Text>
              </Heading>
              <Text mt={"1em"} color="#001664">
                <a style={{ fontWeight: "600" }}>1. {t("Set up a Metamask wallet")}:</a> {t("If you")} <Link href="https://metamask.io/" color="white" isExternal>{t("Metamask website")}</Link>  {t("and install the extension for your web browser or use the MetaMask Mobile Browser from the MetaMask mobile app")}.
              </Text>
              <Text color="#001664">
                <a style={{ fontWeight: "600" }}>2. {t("Visit Yubiai")}:</a> {t("Go to the")} <Link href="https://app.yubiai.market/" color="white" isExternal>{t("Yubiai app")}</Link>
              </Text>
              <Text color="#001664">
              ...
              <Text color="#001664">
                {t("Follow the instructions as")} <Link href="#sellerSection">{t("Seller")}</Link> {t("or")} <Link href="#buyerSection">{t("Buyer")}</Link> {t("below")}.
              </Text>
              <Divider my={4} borderColor={"black"} />
              <Heading mt="0.25em">
                <Text fontSize={"42px"} color="white">{t("How does Yubiai work?")}</Text>
              </Heading>
              <Text mt={"1em"} color="#001664">
              ...
              <Divider my={4} borderColor={"black"} />
              <Heading mt="0.25em">
                <Text fontSize={"42px"} color="white">{t("I want to invest")}</Text>
              </Heading>
              <Text mt={"1em"} color="#001664">
                {t("Yes, we are")}.
              </Text>
              <Divider my={4} borderColor={"black"} />
              <Heading mt="0.25em">
                <Text fontSize={"42px"} color="white">{t("How much you have raised so far?")}</Text>
              </Heading>
              <Text mt={"1em"} color="#001664">
                {t("So far")}.
              </Text>
              <Divider my={4} borderColor={"black"} />
              <Heading mt="0.25em">
                <Text color="white">{t("Are you incorporated?")}</Text>
              </Heading>
              <Text mt={"1em"} color="#001664">
              ...
              <Divider my={4} borderColor={"black"} />
              <Heading mt="0.25em">
                <Text color="white">{t("I have a question that is not answered here")}.</Text>
              </Heading>
              <Text mt={"1em"} color="#001664">
                {t("For any other questions, don’t hesitate to contact us at")} <Link href="mailto:contact@yubiai.market" color="white">contact@yubiai.market</Link>
              </Text>
              <Divider my={4} borderColor={"black"} />
            </Box>
            <Stack
              ...
              mb="2em"
            >
              <BuyerFaqCard t={t} lng={lang} />
              <SellerFaqCard t={t} lng={lang}/>
            </Stack>
          </Flex>
        </Flex >
      </HeroFather>
